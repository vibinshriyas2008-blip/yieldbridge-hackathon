  ...
  if (submitted) {
    return (
      <div className="max-w-2xl mx-auto text-center py-20">
        ...
        <p className="text-xl text-gray-800 mb-8">The farmer has been notified of your offer. You will be alerted if they accept.</p>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-8">
        <div className="p-8 flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-1/3 h-48 md:h-auto bg-green-600 rounded-xl flex items-center justify-center text-white font-bold text-3xl tracking-widest uppercase shadow-inner relative overflow-hidden">
            ...
            <div className="absolute top-3 left-3 bg-white px-3 py-1 rounded-full text-xs font-bold text-gray-900 shadow-sm z-10">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-lg text-gray-800 font-medium">{listing.quantity} tonnes available</p>
              </div>
              <div className="text-right bg-blue-50 px-4 py-2 rounded-xl border border-blue-100">
                <p className="text-sm text-blue-700 font-bold mb-1">Expected Price</p>
                <p className="text-2xl font-bold text-gray-900">₹{listing.expectedPrice}<span className="text-base font-normal text-gray-700">/kg</span></p>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="flex items-center gap-3 text-gray-800 bg-gray-50 p-3 rounded-lg border border-gray-100">
                <div className="bg-white p-2 rounded-full shadow-sm">
                  <User className="w-4 h-4 text-blue-500" />
                </div>
                <div>
                  <p className="text-xs text-gray-700 font-semibold">Farmer</p>
              ...
              <div className="flex items-center gap-3 text-gray-800 bg-gray-50 p-3 rounded-lg border border-gray-100">
                ...
                <div>
                  <p className="text-xs text-gray-700 font-semibold">Location</p>
                  <p className="font-semibold text-gray-900 truncate" title={listing.location}>{listing.location.split(',')[0]}</p>
                </div>
              </div>
            </div>

            <p className="text-sm text-gray-800 bg-gray-50 p-3 rounded-lg border border-gray-100 italic font-medium">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-bold text-gray-900 mb-2">Logistics Preference</label>
              <select required className="w-full border border-gray-300 rounded-lg p-4 text-gray-900 font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
            ...
            <div>
              <label className="block text-sm font-bold text-gray-900 mb-2">Payment Terms</label>
              <select required className="w-full border border-gray-300 rounded-lg p-4 text-gray-900 font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
          ...
          <div className="pt-6 border-t border-gray-100 flex justify-end gap-4">
            <Link href="/buyer" className="px-6 py-3 border border-gray-300 rounded-xl text-gray-900 font-medium hover:bg-gray-50 transition-colors">
              Cancel
            </Link>
            <button 
              type="submit" 
