    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4 font-sans">
      <div className="max-w-5xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-800">Revealing hidden margins and empowering the agricultural ecosystem.</p>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-12">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 text-center">
            <p className="text-sm text-gray-800 font-medium mb-1">Farmers Connected</p>
            <p className="text-3xl font-bold text-purple-600">12,450</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 text-center">
            <p className="text-sm text-gray-800 font-medium mb-1">Produce Traded</p>
            <p className="text-3xl font-bold text-purple-600">8,200 <span className="text-lg font-normal text-gray-800">tonnes</span></p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 text-center">
            <p className="text-sm text-gray-800 font-medium mb-1">Avg. Farmer Revenue Increase</p>
            <p className="text-3xl font-bold text-green-600 flex justify-center items-center gap-1">
              <TrendingUp className="w-6 h-6" /> 18%
            </p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 text-center">
            <p className="text-sm text-gray-800 font-medium mb-1">Avg. Buyer Cost Reduction</p>
                ...
                <div className="space-y-6 relative">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 bg-gray-50 p-4 rounded-xl border border-gray-200">
                      <p className="text-sm text-gray-800 mb-1">Farmer receives</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 bg-gray-50 p-4 rounded-xl border border-gray-200 flex justify-between items-center">
                      ...
                      <p className="font-bold text-gray-800">+₹4.00</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 bg-gray-50 p-4 rounded-xl border border-gray-200 flex justify-between items-center">
                      ...
                      <p className="font-bold text-gray-800">+₹3.00</p>
                    </div>
                  </div>
                ...
                <div className="space-y-6 relative">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 bg-white p-4 rounded-xl border border-gray-200 flex justify-between items-center">
                      ...
                      <p className="font-bold text-gray-800">+₹0.50</p>
                    </div>
                  </div>
